...
# with open('D:/ML internship/image-search-engine/main/model/filenames1.pkl', 'rb') as file:
#     filename_list = pickle.load(file)

# new_filename_list = [filename.replace(
#     'D:/ML internship/image-search-engine/Dataset/MY_data\\', '') for filename in filename_list]

# with open('D:/ML internship/image-search-engine/main/model/filenames1.pkl', 'wb') as file:
#     pickle.dump(new_filename_list, file)
